...
/**
 * In-layout notifications. Based on  android.widget.Toast} notifications
...
public class AppMsg {
    ...
    /**
     * Construct an empty AppMsg object. You must call  #setView} before
     * you can call  #show}.
     *
    ...
    /**
     * Make a  com.yugy.v2ex.daily.widget.AppMsg} that just contains a text view.
     *
     * @param context The context to use. Usually your
     *                 android.app.Activity} object.
    ...
    /**
     * Make a  com.yugy.v2ex.daily.widget.AppMsg} with a custom layout. The layout must have a  TextView} com id  android.R.id.message}
     *
     * @param context The context to use. Usually your
     *                 android.app.Activity} object.
     * @param text    The text to show. Can be formatted text.
    ...
    /**
     * Make a non-floating  com.yugy.v2ex.daily.widget.AppMsg} with a custom view presented inside the layout.
    ...
    /**
     * Make a  com.yugy.v2ex.daily.widget.AppMsg} with a custom view. It can be used to create non-floating notifications if floating is false.
     *
     * @param context  The context to use. Usually your
     *                  android.app.Activity} object.
     * @param view
    ...
    /**
     * Make a  com.yugy.v2ex.daily.widget.AppMsg} that just contains a text view with the text from a
     * resource.
     *
     * @param context The context to use. Usually your
     *                 android.app.Activity} object.
    ...
    /**
     * Make a  com.yugy.v2ex.daily.widget.AppMsg} with a custom layout using the text from a
     * resource. The layout must have a  TextView} com id  android.R.id.message}
     *
     * @param context The context to use. Usually your
     *                 android.app.Activity} object.
     * @param resId   The resource id of the string resource to use. Can be
    ...
    /**
     * @return <code>true</code> if the  com.yugy.v2ex.daily.widget.AppMsg} is being displayed, else <code>false</code>.
     */
    ...
    /**
     * Cancels all queued  com.yugy.v2ex.daily.widget.AppMsg}s. If there is a  com.yugy.v2ex.daily.widget.AppMsg}
    ...
    public LayoutParams getLayoutParams() {
        if (mLayoutParams == null) {
           mLayoutParams = new FrameLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
            ...
            int dp = (int) (56 * scale + 0.5f);
            ((FrameLayout.LayoutParams) mLayoutParams).topMargin = dp;
        }
    ...
    /**
     * The style for a  com.yugy.v2ex.daily.widget.AppMsg}.
     *
     * @author e.shishkin
     */
    public static class Style {
        ...
        /**
         * Construct an  com.yugy.v2ex.daily.widget.AppMsg.Style} object.
         *
