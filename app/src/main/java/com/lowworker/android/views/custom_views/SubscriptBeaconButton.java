 ...
 */
public class SubscriptBeaconButton extends ViewAnimator {
    ...
    public SubscriptBeaconButton(Context context) {
        super(context);
        init();
    }

    public SubscriptBeaconButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_subscript_beacon_button, this, true);
    }
...
//            setEnabled(false);
            setBackgroundResource(R.drawable.btn_subscript_beacon);
...
//            setEnabled(true);
            setBackgroundResource(R.drawable.btn_subscripte_beacon_done);
