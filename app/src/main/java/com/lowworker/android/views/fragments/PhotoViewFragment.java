...
package com.lowworker.android.views.fragments;
...
import com.lowworker.android.views.custom_views.photo.ImageUtils;
import com.lowworker.android.views.custom_views.photo.PhotoView;
import com.lowworker.android.views.custom_views.photo.PhotoViewCallbacks;
...
public class PhotoViewFragment extends Fragment implements
    ...
    private void startLoadBitmapTask() {
        try {
            Log.d("startLoadBitmapTask", mDownloadUrl.toString());
            Picasso.with(getActivity().getApplicationContext()).load(mDownloadUrl).into(new Target() {
...
//            displayPhoto(Picasso.with(getActivity().getApplicationContext()).load(mDownloadUrl).get()) ;
        } catch (Exception e) {
    ...
    private void displayPhoto(Bitmap data) {
        Log.d("displayPhoto","displayPhoto");
        bindPhoto(data);
    }
    ...
    private void bindPhoto(Bitmap bitmap) {
        if (bitmap != null) {
            ...
            if (mPhotoView != null) {
                Log.d("mPhotoView != null","mPhotoView != null");
