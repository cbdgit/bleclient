...
import com.lowworker.android.views.adapters.PhotoViewerPagerAdapter;
import com.lowworker.android.views.custom_views.photo.Intents;
import com.lowworker.android.views.custom_views.photo.PhotoViewCallbacks;
import com.lowworker.android.views.custom_views.photo.PhotoViewPager;
 ...
 */
public class PhotoViewActivity extends Activity implements ViewPager.OnPageChangeListener, PhotoViewPager.OnInterceptTouchListener, PhotoViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("mPhohoUrls",mPhohoUrls.toString());
